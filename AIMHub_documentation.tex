...
\begin{itemize}
\item Copy IAMCTemplate.txt and paste it into the "TemplateRepo" sheet of variable_list_IAMC.xlsx. This will create a Name-Code correspondence table in columns F and G of "template_sheet".
\item Paste the variable name required for this MIP into column B of “template_sheet.” This will create a Code in column C. 
...
\item Paste this into include_parameter.txt. Only the variables written here will be extracted and merged from the gdx files of the IAMCtemplate for each scenario, resulting in global_17_IAMC.gdx and global_17_IAMC.cvs.
